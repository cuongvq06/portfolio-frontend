    ...
    <div class="card-body">
      ...
      <div class="items-section">
        ...
        <div v-for="(item, index) in form.items" :key="index" class="item-row">
          ...
          <!-- Giữ nguyên mục giá bán linh hoạt -->
          <div class="flex-1">
...
const props = defineProps(["campaignId", "orderData"]);
const emit = defineEmits(["navigate"]);

const campaign = ref(null);
const form = ref({ noteImage: "", ...props.orderData });
const errors = ref({});
...
<style scoped>
/* Đồng bộ CSS với bên file Thêm để có giao diện tinh gọn */
.form-card {
  max-width: 800px;
  margin: 0 auto;
  background: #fff;
